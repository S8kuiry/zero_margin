        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden md:flex items-center">
            <input
              type="text"
              placeholder="Search..."
              className="w-48 md:w-56 lg:b-64 transition-all duration-300 border border-black/30 bg-black/10 text-white placeholder-white/60 rounded-full px-4 py-2 focus:ring-2 focus:ring-orange-500 outline-none"
            />
